  ...
  return (
    <div className="flex flex-col h-full w-full bg-muted/20">
      ...
      <div className="p-6 bg-slate-900 text-white flex justify-between items-center rounded-t-[2.5rem] shadow-2xl">
        ...
        <Button className="bg-white text-slate-900 hover:bg-emerald-500 hover:text-white px-8 h-14 rounded-2xl font-black uppercase tracking-widest transition-all">
          Clôturer Shift
        </Button>
      </div>
    </div>
