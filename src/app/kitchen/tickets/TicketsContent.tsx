...
import {
    ...
    Timer, CheckCircle2, PlayCircle, Layers
} from "lucide-react";
    ...
    if (!stationId) {
        return (
            <div className="h-screen flex flex-col items-center justify-center gap-4 bg-slate-950 text-white">
                ...
                <Button variant="outline" onClick={() => router.push('/kitchen')} className="rounded-full">
                    Retour au Dashboard
                </Button>
            </div>
        );
                ...
                <div className="px-6 py-4 flex items-center justify-between">
                    <div className="flex items-center gap-6">
                        <Button
                            ...
                            className="rounded-2xl h-14 w-14 bg-slate-50 dark:bg-slate-800 hover:bg-primary hover:text-white transition-all"
                        >
                            <ChevronLeft size={28} />
                        </Button>
                        <div>
                            <div className="flex items-center gap-2">
                                <h1 className="font-black text-2xl uppercase italic tracking-tighter">Préparation</h1>
